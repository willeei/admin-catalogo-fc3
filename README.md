<div style="text-align: center;">
  <p style="text-align: center">
    <img src="https://icon-library.com/images/java-icon-png/java-icon-png-15.jpg"  width="150"  alt=""/>
  </p>  
  <h1 style="text-align: center">🚀 Microserviço: Admin do Catálogo de Vídeos com Java</h1>
  <p style="text-align: center">
...
Caso seja a primeira vez que esteja a subir o banco de dados, é necessário
...
Quando isso acontecer o flyway ficará num estado de reparação
