...
import tech.willeei.admin.catalogo.infrastructure.api.VideoAPI;
import tech.willeei.admin.catalogo.infrastructure.utils.HashingUtils;
...
import tech.willeei.admin.catalogo.infrastructure.video.models.VideoListResponse;
import tech.willeei.admin.catalogo.infrastructure.video.models.VideoResponse;
import tech.willeei.admin.catalogo.infrastructure.video.presenters.VideoApiPresenter;

import java.net.URI;
import java.util.Objects;
import java.util.Set;

import static tech.willeei.admin.catalogo.domain.exceptions.DomainException.with;
...
public class VideoController implements VideoAPI {
    ...
    public ResponseEntity<?> uploadMediaByType(final String id, final String type, final MultipartFile media) {
        final var aType = VideoMediaType.of(type)
                .orElseThrow(() -> with(new Error("Invalid %s for VideoMediaType".formatted(type))));
