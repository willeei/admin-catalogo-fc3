...
class CategoryRepositoryTest {
    ...
    void givenAnInvalidNullName_whenCallsSave_shouldReturnError() {
        ...
        final var expectedMessage = "not-null property references a null or transient value : br.com.williamsbarriquero.admin.catalogo.infrastructure.category.persistence.CategoryJpaEntity.name";
        final var aCategory =
    ...
    void givenAnInvalidNullCreatedAt_whenCallsSave_shouldReturnError() {
        ...
        final var expectedMessage = "not-null property references a null or transient value : br.com.williamsbarriquero.admin.catalogo.infrastructure.category.persistence.CategoryJpaEntity.createdAt";
        final var aCategory =
                Category.newCategory("Filmes", "A categoria mais assistida", true);
    ...
    void givenAnInvalidNullUpdatedAt_whenCallsSave_shouldReturnError() {
        ...
        final var expectedMessage = "not-null property references a null or transient value : br.com.williamsbarriquero.admin.catalogo.infrastructure.category.persistence.CategoryJpaEntity.updatedAt";
        final var aCategory =
                Category.newCategory("Filmes", "A categoria mais assistida", true);
