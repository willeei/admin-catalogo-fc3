...
class VideoAPITest {
    ...
    void givenAValidCommand_whenCallsCreateFull_shouldReturnAnId() throws Exception {
        ...
        final var expectedThumbHalf =
                new MockMultipartFile("video_file", "thumbnailHalf.jpg", "image/jpg", "THUMBHALF".getBytes());
        ...
        final var aRequest = multipart("/videos")
                ...
                .param("cast_member_id", williams.getId().getValue())
        ...
        Assertions.assertEquals(expectedRating, actualCmd.rating());
