package tech.willeei.admin.catalogo.application.video;
...
import tech.willeei.admin.catalogo.infrastructure.video.DefaultVideoGateway;
...
class DefaultVideoGatewayTest {
    ...
    private CastMember williams;
    private CastMember maju;
    ...
    void givenAValidVideo_whenCallsCreate_shouldPersistIt() {
        ...
        final var expectedMembers = Set.of(williams.getId());
    ...
    private void mockVideos() {
        videoGateway.create(Video.newVideo(
                ...
                Set.of(lives.getId()),
                Set.of(tech.getId()),
                Set.of(williams.getId(), maju.getId())
        ));
